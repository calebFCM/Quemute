...
export default class Login extends React.Component{
   ...
   //  		this.setState({credentialsSet: false, loading: false});
   //  		return;
   //  	}

   //  	var fomrString = encodeURIComponent("email") + "=" + encodeURIComponent(email) + "&" + encodeURIComponent("password") + "=" + 
   //  	encodeURIComponent(password);
    	
   //  	fetch('https://www.quemute.com/userlogin', {
  	// 		method: 'POST',
  	// 		headers: {
   //  			'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
	...
	// 			await AsyncStorage.setItem("user_profile", userString);
    	...
    	return(
    		<ScrollView keyboardDismissMode='none'
    			...
    			<View style={styles.container}>
					...
					<View>
						<Text style={{left: '5%', color:"#aaaaaa", fontWeight: '400' }}>Please Sign in to continue</Text>
					</View>
					...
					<View>
						<TouchableOpacity>
							<Text style={{right: '5%', color:"#5DBDE3", fontWeight: '400',alignSelf: 'flex-end' }}>Forgot Password?</Text>
						</TouchableOpacity>
					</View>
					...
					<View style={styles.fgtPswd}>
						...
						<TouchableOpacity style={{}} onPress={() => {this.register()}}>
							<Text style={{fontWeight: 'bold', color: '#841A1D',marginLeft: 147, top: -20, alignSelf: 'flex-end'}}>SIGN UP</Text>
						</TouchableOpacity>
					</View>
